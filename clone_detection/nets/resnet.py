...
class ResNet(nn.Module):
    ...
    def __init__(self, init_channel, layers: List[int], dropout=False):
...
def ResNet50(init_channel, dropout=False):
    return ResNet(init_channel, [3, 4, 6, 3], dropout)


def ResNet101(init_channel, dropout=False):
    return ResNet(init_channel, [3, 4, 23, 3], dropout)


def ResNet152(init_channel, dropout=False):
    return ResNet(init_channel, [3, 8, 36, 3], dropout)
